...
var GradientComponent = /** @class */ (function () {
    ...
    GradientComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: "gradient-component",template:/*ion-inline-start:"C:\projects\zhijiatablet\smart_app\app\src\components\switch\gradient.component.html"*/'<!-- 渐变隐藏-->\n\n<span [ngSwitch]="type">\n\n  <!--显示-->\n\n  <ng-template [ngSwitchCase]="\'show\'">\n\n   <div class="equipment-status-tips"><h3>{{value}}</h3></div>\n\n  </ng-template>\n\n  <!--渐变隐藏-->\n\n  <ng-template [ngSwitchCase]="\'hide\'">\n\n     <div class="equipment-status-tips equipment-status-tips-animate"><h3>{{value}}</h3></div>\n\n  </ng-template>\n\n  <!--关闭-->\n\n  <ng-template [ngSwitchCase]="\'null\'">\n\n    <div ><h3></h3></div>\n\n  </ng-template>\n\n</span>'/*ion-inline-end:"C:\projects\zhijiatablet\smart_app\app\src\components\switch\gradient.component.html"*/,
        })
        //开关按钮样式状态
    ], GradientComponent);
...
var DoorlockComponent = /** @class */ (function () {
    ...
    DoorlockComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'doorlock-device',template:/*ion-inline-start:"C:\projects\zhijiatablet\smart_app\app\src\components\doorlock\doorlock.html"*/'<ion-item *ngIf="type===0">\n\n  <ion-avatar item-left (click)="pushPage()">\n\n    <img src="{{src}}" />\n\n    <span *ngIf="isgroup" class="equipment-item-action-groups"><ion-icon class="iconfont icon-fenlei"></ion-icon></span>\n\n  </ion-avatar>\n\n  <h2 (click)="pushPage()">{{deviceinfo.name}}</h2>\n\n  <p (click)="pushPage()">{{onlinestatus}}</p>\n\n  <div item-right *ngIf="locklowpower">\n\n    <span class="equipment-item-type">\n\n        <ion-icon name="ios-battery-dead"></ion-icon>\n\n        <p>锁低电量提示</p>\n\n    </span>\n\n  </div>\n\n</ion-item>\n\n<div *ngIf="type===1" class="equipment-home-item" (click)="pushPage()">\n\n  <div class="equipment-thumbnail">\n\n    <img src="{{src}}" />\n\n    <span *ngIf="isgroup" class="equipment-item-action-groups"><ion-icon class="iconfont icon-fenlei"></ion-icon></span>\n\n  </div>\n\n  <h2>{{deviceinfo.name}}</h2>\n\n  <p>{{onlinestatus}}</p>\n\n</div>'/*ion-inline-end:"C:\projects\zhijiatablet\smart_app\app\src\components\doorlock\doorlock.html"*/
        }),
...
var DemonstrationComponent = /** @class */ (function () {
    ...
    DemonstrationComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'demonstration',template:/*ion-inline-start:"C:\projects\zhijiatablet\smart_app\app\src\components\demonstration\demonstration.html"*/'<div *ngIf="type===0">\n\n  <ion-item>\n\n    <ion-avatar item-left (click)="pushDPage()">\n\n      <img src="{{src}}" />\n\n      <span *ngIf="isgroup" class="equipment-item-action-groups"><ion-icon class="iconfont icon-fenlei"></ion-icon></span>\n\n    </ion-avatar>\n\n    <ion-label>\n\n      <h2 (click)="pushDPage()">{{deviceinfo.name}}</h2>\n\n      <p (click)="pushDPage()">{{online}}</p>\n\n    </ion-label>\n\n    <div item-right *ngIf="deviceproduct===demo_doorbell">\n\n      <button ion-button outline icon-only [disabled]="isatus" class="button-power" (click)="doorbellclick()">\n\n                        <ion-icon class="iconfont icon-zhenling"></ion-icon>\n\n                    </button>\n\n    </div>\n\n  </ion-item>\n\n</div>\n\n<div *ngIf="type===1" class="equipment-home-item" (click)="pushDPage()">\n\n  <div class="equipment-thumbnail">\n\n    <img src="{{src}}" />\n\n    <span *ngIf="isgroup" class="equipment-item-action-groups"><ion-icon class="iconfont icon-fenlei"></ion-icon></span>\n\n  </div>\n\n  <h2>{{deviceinfo.name}}</h2>\n\n</div>'/*ion-inline-end:"C:\projects\zhijiatablet\smart_app\app\src\components\demonstration\demonstration.html"*/
        }),
...
var AirdetectorComponent = /** @class */ (function () {
    ...
    AirdetectorComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'airdetector',template:/*ion-inline-start:"C:\projects\zhijiatablet\smart_app\app\src\components\airdetector\airdetector.html"*/'<ion-item *ngIf="type===0">\n\n  <ion-avatar item-left (click)="pushDPage()">\n\n    <img src="{{src}}" />\n\n  </ion-avatar>\n\n  <h2 (click)="pushDPage()">{{deviceinfo.name}}</h2>\n\n  <p (click)="pushDPage()"> {{pm25}}</p>\n\n</ion-item>\n\n<div *ngIf="type===1" class="equipment-home-item" (click)="pushDPage()">\n\n  <div class="equipment-thumbnail">\n\n    <img src="{{src}}" />\n\n  </div>\n\n  <h2>{{deviceinfo.name}}</h2>\n\n  <p>{{pm25}}</p>\n\n</div>'/*ion-inline-end:"C:\projects\zhijiatablet\smart_app\app\src\components\airdetector\airdetector.html"*/
        })
        //空气检测仪
        ,
...
var DemoncameraComponent = /** @class */ (function () {
    ...
    DemoncameraComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'demoncamera',template:/*ion-inline-start:"C:\projects\zhijiatablet\smart_app\app\src\components\demoncamera\demoncamera.html"*/'<div class="ipad-switch">\n\n    <ion-row center class="ion-row-full align-items-center">\n\n        <ion-col text-center>\n\n            <button color="bright" outline ion-button icon-only class="ipad-button-camera" (click)="OpenVideo()"></button>\n\n            <p>{{title}}</p>\n\n        </ion-col>\n\n    </ion-row>\n\n\n\n</div>'/*ion-inline-end:"C:\projects\zhijiatablet\smart_app\app\src\components\demoncamera\demoncamera.html"*/
        }),
