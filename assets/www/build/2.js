...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SwitchrfwyPageModule", function() { return SwitchrfwyPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(44);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__switchrfwy__ = __webpack_require__(339);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__app_pipe_module__ = __webpack_require__(213);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_colorpicker_lib_color_picker_module__ = __webpack_require__(313);
...
var SwitchrfwyPageModule = /** @class */ (function () {
    function SwitchrfwyPageModule() {
    }
    SwitchrfwyPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["L" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__switchrfwy__["a" /* SwitchrfwyPage */],
            ],
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__switchrfwy__["a" /* SwitchrfwyPage */]),
            ],
            exports: [
                __WEBPACK_IMPORTED_MODULE_2__switchrfwy__["a" /* SwitchrfwyPage */]
            ]
        })
    ], SwitchrfwyPageModule);
    return SwitchrfwyPageModule;
}());

//# sourceMappingURL=switchrfwy.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return SwitchrfwyPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(44);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
...
/**
 * Generated class for the SwitchrfwyPage page.
 *
 * See http://ionicframework.com/docs/components/#navigation for more info
 * on Ionic pages and navigation.
 */
var SwitchrfwyPage = /** @class */ (function () {
    // public config: IColorPickerConfiguration;
    function SwitchrfwyPage(navCtrl, params, 
        ...
        if (this.rgbwy != null) {
            this.w = this.rgbwy.w;
            this.y = this.rgbwy.y;
            this.ct = this.rgbwy.ct;
            this.bn = this.rgbwy.bn;
    ...
    SwitchrfwyPage.prototype.ngOnInit = function () {
    };
    SwitchrfwyPage.prototype.ngOnDestroy = function () {
    };
    SwitchrfwyPage.prototype.touchstate = function (state) {
        this.showHeaderAndFooter = !state;
    };
    SwitchrfwyPage.prototype.advancedsetting = function () {
        var _this = this;
        var modal = this.mc.create("advancedsetting_wy", { device_id: this.deviceinfo.device_id, w: parseInt(this.w + ''), y: parseInt(this.y + ''), ct: this.ct, bn: this.bn, time: this.time, unchange: true });
        modal.onDidDismiss(function (data) {
            if (data) {
                ...
                // this.ct = data.ct;
                // this.bn = data.bn;
                // this.y = parseInt((255 * this.ct / 100 * this.bn / 100) + "");
                // this.w = parseInt((255 * (100 - this.ct) / 100 * this.bn / 100) + "");
                _this.time = data.time;
            }
        });
        modal.present();
    };
    SwitchrfwyPage.prototype.ngAfterViewInit = function () {
        var element = this.lightswitchcontentElement;
        var height = parseInt(element._elementRef.nativeElement.offsetHeight);
        this.colorAreaHeight = height;
        this.contentHeight = height;
    };
    SwitchrfwyPage.prototype.onChangeTemperature = function (val) {
        this.ct = val.ct;
        this.bn = val.bn;
        this.y = 255 * this.ct / 100 * this.bn / 100;
        this.w = 255 * (100 - this.ct) / 100 * this.bn / 100;
    };
    SwitchrfwyPage.prototype.ok = function () {
        var rgbwy = "0,0,0," + this.w + "," + this.y + "," + this.time + "," + this.bn + "," + this.ct;
        this.dismiss(rgbwy);
    };
    //关闭modal
    SwitchrfwyPage.prototype.dismiss = function (data) {
        var _this = this;
    ...
    __decorate([
        ...
        __metadata("design:type", Object)
    ], SwitchrfwyPage.prototype, "lightswitchcontentElement", void 0);
    SwitchrfwyPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'page-switchrfwy',template:/*ion-inline-start:"C:\projects\zhijiatablet\smart_app\app\src\pages\switchrfwy\switchrfwy.html"*/'<ion-header no-shadow [style.display]="showHeaderAndFooter?\'block\':\'none\'">\n\n    <ion-navbar transparent no-border-bottom class="toolbar-color-white">\n\n        <ion-title>{{title}}</ion-title>\n\n    </ion-navbar>\n\n</ion-header>\n\n<ion-content class="fixedcontent  ion-content-temperature"  scroll="false" #lightswitchcontent>\n\n    <div style="width:100%;display:block" [colorPicker]="color" style="width:100%;display:block" (cpTouchChange)="touchstate($event)"\n\n        [contentHeight]="contentHeight" [cpType]="\'wy\'"  class=" color-drag-content"  [cpDialogDisplay]="\'inline\'" (cpTemperatureChange)="onChangeTemperature($event);"\n\n        [cpCt]="ct" [cpBn]="bn">\n\n    </div>\n\n</ion-content>\n\n<ion-footer no-shadow [style.display]="showHeaderAndFooter?\'block\':\'none\'">\n\n    <ion-toolbar transparent>\n\n        <ion-row class="row-switch grid-flex-column">\n\n            <ion-col>\n\n                <button color="default" ion-button outline class="button-power" (click)="advancedsetting()">\n\n                    <ion-icon class="iconfont icon-shezhi"></ion-icon>\n\n                </button>\n\n                <p>常用</p>\n\n            </ion-col>\n\n            <ion-col>\n\n                <button color="default" ion-button outline class="button-power" (click)="ok()">\n\n                    <ion-icon name="ios-power"></ion-icon>\n\n                </button>\n\n                <p>保存</p>\n\n            </ion-col>\n\n        </ion-row>\n\n    </ion-toolbar>\n\n</ion-footer>'/*ion-inline-end:"C:\projects\zhijiatablet\smart_app\app\src\pages\switchrfwy\switchrfwy.html"*/,
        }),
    ...
    return SwitchrfwyPage;
}());

//# sourceMappingURL=switchrfwy.js.map
